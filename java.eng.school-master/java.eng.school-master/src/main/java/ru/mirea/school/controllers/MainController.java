...
public class MainController {
    ...
    public String home(Model model, Principal principal) {
        ...
        if (auth.getAuthorities().iterator().next().toString().equals("ROLE_ADMIN")) {
            ...
            model.addAttribute("title", "ARTSchool - Администратор");
        ...
        Iterable<TeachingProgram> teachingPrograms = teachingProgramRepository.findAll();
        model.addAttribute("title", "ARTSchool - Главная");
        model.addAttribute("teachingPrograms", teachingPrograms);
        model.addAttribute("user", userRepository.getUserByUsername(principal.getName()));
        return "index";
    }
    ...
    public String auth(Model model) {
        model.addAttribute("title", "ARTSchool - Авторизация");
    ...
    public String payment(Model model, Principal principal) {
        model.addAttribute("title", "ARTSchool - Оплата подписки");
        model.addAttribute("user", userRepository.getUserByUsername(principal.getName()));
    ...
    public String editProgram(@PathVariable String id, Model model) {
        if (id.equals("new")) {
            model.addAttribute("title", "ARTSchool - Программа обучения");
            ...
            model.addAttribute("title", "School - Редактирование программ обучения");
    ...
    public String edit(Model model, Principal principal) {
        model.addAttribute("title", "ARTSchool - Редактировать");
        model.addAttribute("user", userRepository.getUserByUsername(principal.getName()));
        return "edit";
    }
